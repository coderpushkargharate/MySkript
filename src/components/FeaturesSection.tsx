...
>
  ...
  scalable solutions designed to grow with you.
      ...
      <div className="flex flex-col md:flex-row items-center bg-gray-100 rounded-3xl p-8 shadow-lg">
        <div className="md:w-1/2 mb-8 md:mb-0">
          ...
          <ul className="text-gray-700 list-disc list-inside space-y-1 mb-6">
            <li>
  ...
  <div className="md:w-1/2 mb-8 md:mb-0">
    ...
    <ul className="text-gray-700 list-disc list-inside space-y-1 mb-6">
      ...
      <li>Automate followups and reminders effortlessly when the stage in pipeline changes.</li>
    </ul>
    <button className="bg-black text-white px-6 py-3 rounded-lg text-sm font-medium hover:bg-gray-800 transition">
      Get Started For Free
    </button>
  ...
  <div className="md:w-1/2 mb-8 md:mb-0">
    ...
    <button className="bg-black text-white px-6 py-3 rounded-lg text-sm font-medium hover:bg-gray-800 transition flex items-center space-x-2">
  ...
  <div className="md:w-1/2 flex justify-center">
    ...
    />
             ...
             {/* Section 8: Ad Tracking */}
   <div className="flex flex-col md:flex-row items-center bg-gray-100rounded-3xl p-8 shadow-lg">
  {/* Left Image */}
  <div className="md:w-1/2 flex justify-center mb-8 md:mb-0">
    <img
...
<div className="flex flex-col md:flex-row items-center bg-gray-100 rounded-3xl p-8 shadow-lg my-8">
  {/* Left Image */}
  <div className="md:w-1/2 flex justify-center mb-8 md:mb-0">
    <img
