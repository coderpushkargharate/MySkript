        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex justify-between items-center">
                <span>Registration Fee (refundable)</span>
            ...
            <div className="bg-blue-50 rounded-xl p-4 mb-6">
              ...
              <ul className="space-y-2 text-sm text-blue-800">
                ...
                <li>• You'll be charged {plan.price} after the trial period</li>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <form className="space-y-6">
              ...
              <p className="text-xs text-gray-500 text-center leading-relaxed">
                By confirming your subscription, you allow automatic recurring payments in accordance with their terms. You can always cancel your subscription.
              </p>
            </form>
          </div>
        </div>
